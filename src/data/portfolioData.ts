...
export const SKILLS: Skill[] = [
  ...
  { id: 35, name: 'Python', category: 'Backend', level: 92, sort_order: 9 },
  { id: 36, name: 'RAG & Vector Search', category: 'Backend', level: 90, sort_order: 10 },
  { id: 9, name: 'Laravel', category: 'Backend', level: 86, sort_order: 11 },
  { id: 10, name: 'C++', category: 'Backend', level: 85, sort_order: 11 },
  { id: 11, name: 'Java', category: 'Backend', level: 88, sort_order: 12 },
  { id: 12, name: 'PostgreSQL / Supabase', category: 'Backend', level: 88, sort_order: 13 },
  { id: 13, name: 'MongoDB', category: 'Backend', level: 85, sort_order: 14 },
  { id: 14, name: 'Prisma ORM', category: 'Backend', level: 86, sort_order: 15 },
  { id: 15, name: 'REST & GraphQL APIs', category: 'Backend', level: 92, sort_order: 16 },
  { id: 31, name: 'DAST & Web Security', category: 'Backend', level: 90, sort_order: 17 },
  { id: 32, name: 'Cryptography & Hashing', category: 'Backend', level: 88, sort_order: 18 },

  // Mobile
  { id: 16, name: 'Flutter', category: 'Mobile', level: 92, sort_order: 19 },
  { id: 17, name: 'Dart', category: 'Mobile', level: 90, sort_order: 20 },
  { id: 18, name: 'Java Swing', category: 'Mobile', level: 82, sort_order: 21 },
  { id: 19, name: 'Firebase', category: 'Mobile', level: 88, sort_order: 22 },
  { id: 20, name: 'Android Studio', category: 'Mobile', level: 85, sort_order: 23 },

  // Tools & DevOps
  { id: 21, name: 'AWS', category: 'Tools & DevOps', level: 85, sort_order: 24 },
  { id: 22, name: 'Azure', category: 'Tools & DevOps', level: 82, sort_order: 25 },
  { id: 23, name: 'Kubernetes', category: 'Tools & DevOps', level: 80, sort_order: 26 },
  { id: 24, name: 'Docker', category: 'Tools & DevOps', level: 85, sort_order: 27 },
  { id: 25, name: 'Git & GitHub', category: 'Tools & DevOps', level: 94, sort_order: 28 },
  { id: 26, name: 'Google Tag Manager', category: 'Tools & DevOps', level: 88, sort_order: 29 },
  { id: 27, name: 'CI/CD & Vercel', category: 'Tools & DevOps', level: 90, sort_order: 30 },
  { id: 28, name: 'Postman', category: 'Tools & DevOps', level: 92, sort_order: 31 },
  { id: 29, name: 'Figma', category: 'Tools & DevOps', level: 85, sort_order: 32 },
  { id: 30, name: 'Linux / Bash', category: 'Tools & DevOps', level: 84, sort_order: 33 },
  { id: 33, name: 'OWASP Top 10', category: 'Tools & DevOps', level: 92, sort_order: 34 },
  { id: 34, name: 'Penetration Testing', category: 'Tools & DevOps', level: 88, sort_order: 35 },
];
...
export const PROJECTS: Project[] = [
  // Top Selected Projects (Featured)
  {
    id: 8,
    title: 'Voxa',
    tagline: 'Multilingual AI Voice Assistant with RAG',
    description:
      'A production-quality, multilingual AI voice assistant application powered by Google Gemini Live native audio, Supabase pgvector RAG, and LiveKit Cloud. Enables natural, low-latency, bidirectional voice conversations with real-time barge-in, dynamic language/region adaptation, customizable AI voices, audio device selection, grounded business knowledge retrieval, and Progressive Web App (PWA) offline awareness.',
    category: 'Full Stack',
    tech: ['Next.js', 'Python', 'LiveKit Cloud', 'Google Gemini', 'RAG', 'PWA', 'TypeScript', 'Tailwind CSS'],
    demo_url: 'https://global-voice-agent.vercel.app/',
    github_url: null,
    year: '2025',
    featured: true,
    sort_order: 1,
